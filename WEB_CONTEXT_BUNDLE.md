...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1109-erd-s-problem-1109-3af7b996-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1109"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1109-erd-s-problem-1109-3af7b996-v1",
      "problem_contract_sha256": "3f0c0ed7084008ca8e4d6f611e5ea86eb98bda2a0bf7cc34c8eb91ca027ac397",
      "problem_id": "problem:um-ep-1109-erd-s-problem-1109-3af7b996",
      "route_id": "route:um-ep-1109-erd-s-problem-1109-3af7b996-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1109-erd-s-problem-1109-3af7b996-source-fidelity-01",
      "graph_id": "graph:um-ep-1109-erd-s-problem-1109-3af7b996-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1109-erd-s-problem-1109-3af7b996-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1109-erd-s-problem-1109-3af7b996-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f(N)$ be the size of the largest subset $A\\subseteq \\{1,\\ldots,N\\}$ such that every $n\\in A+A$ is squarefree. Estimate $f(N)$. In particular, is it true that $f(N)\\leq N^{o(1)}$, or even $f(N) \\leq (\\log N)^{O(1)}$?"
          },
          "statement_sha256": "907223a12b1d67a884b87ef572c3927c890ba24fdead81ad838694506baa0cb3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1109-erd-s-problem-1109-3af7b996-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1109-erd-s-problem-1109-3af7b996-root",
      "route_id": "route:um-ep-1109-erd-s-problem-1109-3af7b996-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1109-d78f5b843bba",
        "url": "https://www.unsolvedmath.com/problems/EP-1109"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
